...
class BellRequest(Base):
    ...
    title: Mapped[str] = mapped_column(String(200), nullable=False) # e.g. 'Luggage Pickup', 'Room Move Assistance'
    
    location: Mapped[str] = mapped_column(String(100), nullable=False) # e.g. 'Room 402', 'Room 215 to 510', 'Lobby Lounge'
