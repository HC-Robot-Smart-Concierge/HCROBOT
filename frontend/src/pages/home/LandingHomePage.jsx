...
export const LandingHomePage = ({
  ...
  return (
    <div className="hc-page-container custom-scrollbar">
      {/* 1. Header Minimalist */}
      ...
      <main className="max-w-3xl w-full mx-auto px-6 py-12 flex-1 flex flex-col justify-center items-center text-center">
        ...
        <p className="hc-text-body max-w-xl mt-3.5">
        ...
        {/* NÚT ĐĂNG NHẬP VÀO HỆ THỐNG (1 NÚT MÀU XÁM SIGNATURE, KHÔNG DÙNG ICON) */}
        <div className="mt-8">
          <button
            onClick={onNavigateToLogin}
            className="hc-btn-home"
          >
        ...
        <div id="about" className="w-full mt-12 pt-8 border-t border-[#E8E4DB] text-center space-y-3 scroll-mt-20">
          <h3 className="hc-heading-section">
            Giới Thiệu Sản Phẩm HC-Robot
          </h3>
          <p className="hc-text-body max-w-2xl mx-auto">
      ...
      {showRobotModal && (
        <div className="hc-modal-overlay animate-fadeIn">
          <div className="hc-modal-box space-y-5">
            <button
